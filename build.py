...
<section>
  <div class="container" style="max-width: 760px;">
    ...
    <form class="contact-form" style="margin-top: 2rem;"
      ...
      <label for="q_semana" style="margin-top: 0;">1 · Cuéntame de un día o una semana normal — ¿en qué lugares estuviste, qué hiciste, cómo fue?</label>
      <textarea id="q_semana" name="q_semana" rows="6"></textarea>

      <label for="q_empezaste">2 · ¿Cómo empezaste con el negocio, y qué es lo que más te gusta del trabajo?</label>
      <textarea id="q_empezaste" name="q_empezaste" rows="6"></textarea>

      <label for="q_otra">3 · ¿Algo más que quieras que la gente sepa de ti o de tu trabajo?</label>
      <textarea id="q_otra" name="q_otra" rows="5"></textarea>
